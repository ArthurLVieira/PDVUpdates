...
uses
  ...
  PDVUpdates.Model.Item.Factory in 'Model\Item\PDVUpdates.Model.Item.Factory.pas',
  PDVUpdates.Model.Item.Factory.Interfaces in 'Model\Item\PDVUpdates.Model.Item.Factory.Interfaces.pas',
  PDVUpdates.Model.Item.State in 'Model\Item\State\PDVUpdates.Model.Item.State.pas',
  PDVUpdates.Model.Item.State.Interfaces in 'Model\Item\State\PDVUpdates.Model.Item.State.Interfaces.pas',
  PDVUpdates.Model.Item.State.Desbloqueado in 'Model\Item\State\PDVUpdates.Model.Item.State.Desbloqueado.pas',
  ...
  PDVUpdates.Model.Empresa.Interfaces in 'Model\Empresa\PDVUpdates.Model.Empresa.Interfaces.pas',
  PDVUpdates.Model.Empresa in 'Model\Empresa\PDVUpdates.Model.Empresa.pas',
  PDVUpdates.Model.Fiscal.Interfaces in 'Model\Fiscal\PDVUpdates.Model.Fiscal.Interfaces.pas',
  PDVUpdates.Model.Fiscal in 'Model\Fiscal\PDVUpdates.Model.Fiscal.pas',
  PDVUpdates.Model.Fiscal.dmSAT in 'Model\Fiscal\SAT\PDVUpdates.Model.Fiscal.dmSAT.pas' {dmSATFiscal: TDataModule},
...
begin
  ...
  Application.CreateForm(TdmSATFiscal, dmSATFiscal);
  Application.Run;
end.
