...
function TModelUsuarioTipoGerente.BloquearCaixa: iModelUsuarioMetodos;
begin
  Result := Self;
end;
...
function TModelUsuarioTipoGerente.DesbloquearCaixa: iModelUsuarioMetodos;
begin
  Result := Self;
end;
...
function TModelUsuarioTipoGerente.Sangria: iModelUsuarioMetodos;
begin
  Result := Self;
end;
...
function TModelUsuarioTipoGerente.Suprimento: iModelUsuarioMetodos;
begin
  Result := Self;
end;
