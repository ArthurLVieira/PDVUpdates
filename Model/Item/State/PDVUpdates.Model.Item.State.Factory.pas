unit PDVUpdates.Model.Item.State.Factory;
...
type
  ...
  TModelItemStateFactory = class(TInterfacedObject, iModelItemState)
  private

  public
    constructor Create;
    destructor Destroy; override;
    class function New: iModelItemState;
...
class function TModelItemStateFactory.New: iModelItemState;
begin
  Result := Self.Create;
end;
